<template>
  ...
  <div v-if="!form.$submitting">
    ...
    <template v-else>
      <gov-error-summary title="Confirm deletion">
        <gov-body>
          Are you sure you want to delete this {{ resource }}? This action is immediate and can not be undone.
        </gov-body>

        <gov-button @click="onDelete" error>Delete</gov-button
        >&nbsp;<!--
